    ...
    alert("All fields required!")
      ...
      .then((querySnapshot) => {
          querySnapshot.forEach((doc) => {
           ...
           var SetOutlook = "<br><small style='font-size: xx-small;font-style: normal;'> **If clicking the above link doesn't open Outlook, <a href='https://support.xink.io/support/solutions/articles/1000174376-how-to-make-mailto-links-open-in-outlook-on-windows-and-macos' target='_blank'><span style='color:#0563C1'>click here </span></a> to learn how to set Outlook as default app for email & then try link again. (<a href='https://www.youtube.com/watch?v=SUiMpD26fNE'  target='_blank'>see video tutorial as well</a>)</small>"; 
